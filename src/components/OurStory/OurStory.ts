export const ourStoryText = [
  ...
  'As the night wore on, both Jen and Wade found themselves unsure about where this newfound connection would lead. They claimed to be "very busy" upon their return, using that as a subtle shield for their apprehension. Little did they know, fate had other plans in store. (dun dun dun)',
  ...
  "Smitten beyond words, Jen and Wade coordinated their first official date, choosing <b>Copycat</b> in DC as the backdrop for their blossoming romance. The night was a delightful blend of conversation, shared dreams, and, of course, some EMO punk rock songs performed by none other than Jen herself. Classic.",

  "From that moment on, Jen and Wade became inseparable. Their laughter echoed through the streets, their hearts danced to a rhythm only they could hear, and their love story continued to unfold with every passing day.",

  "And that, my dear friend, is how Jen and Wade's enchanting tale began. A whimsical journey that started with a chance encounter on a dating app, grew through video chats and casual hangouts, and transformed into a love story filled with laughter, music, and a whole lot of happiness.",
];
